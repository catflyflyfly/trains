...
pub mod args {
    ...
    #[clap()]
    pub struct Network {
        #[clap(long, value_parser = parser::parse_station)]
        pub station: Vec<Station>,

        #[clap(long, value_parser = parser::parse_route)]
        pub route: Vec<Route>,

        #[clap(long, value_parser = parser::parse_package)]
        pub package: Vec<Package>,

        #[clap(long, value_parser = parser::parse_train)]
        pub train: Vec<Train>,
    }
